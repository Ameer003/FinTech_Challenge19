...
# Database of Fintech KryptoJobs2Go candidates including their name, digital address, rating and hourly cost per Ether.
...
def get_people():
    """Display the database of KryptoJobs2Go's candidate information."""
...
# Create a select box to chose a KryptoJobs2Go Hire candidate
...
# Identify the KryptoJobs2Go Hire candidate
